...
RUN apt update&&apt upgrade -y&&apt install -y iputils-ping dnsutils python3-pip tzdata lrzsz net-tools telnet lsof strace tcpdump traceroute ftp clang build-essential wget unzip curl libpq-dev postgresql-server-dev-14 lz4 liblz4-dev libreadline-dev 
